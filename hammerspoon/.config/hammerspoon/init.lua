...
hs.hotkey.bind(hyper, "w", positionWindow(0, 0, 2 / 3, 1))
hs.hotkey.bind(hyper, "e", positionWindow(2 / 3, 0, 1 / 3, 1))
hs.hotkey.bind(hyper, "s", positionWindow(0, 0, 1 / 3, 1))
hs.hotkey.bind(hyper, "d", positionWindow(1 / 3, 0, 2 / 3, 1))
